    ...
    <footer className="bg-foreground text-white">
      <Container className="py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/60 max-w-xs">
              A serene coastal retreat where thoughtful design and warm hospitality
              come together for an unforgettable stay.
            </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 text-xs text-white/50 sm:flex-row">
          <p>
            &copy; {year} {hotelInfo.fullName}. All rights reserved.
          </p>
          <p>Designed with care for every guest.</p>
        </div>
      </Container>
    </footer>
  );
